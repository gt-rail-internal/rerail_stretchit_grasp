...
private:
  ...
  void testHeuristicCallbackAllObjs(const std_msgs::Int32 &msg);
  void testHeuristicCallbackAllPose(const std_msgs::Int32 &msg);
  ...
  ros::Publisher debug_publisher_array_;
  ros::Publisher all_grasps_publisher_;


  ros::Subscriber test_subscriber_;
  ros::Subscriber test_agile_subscriber_;
  ros::Subscriber test_heuristic_subscriber_;
  ros::Subscriber test_heuristic_subscriber_all_objs_;
  ros::Subscriber test_heuristic_subscriber_all_pose_;
